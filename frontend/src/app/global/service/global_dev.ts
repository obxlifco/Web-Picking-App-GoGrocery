...
export const GlobalVariable = Object.freeze({
    //BASE_API_URL: 'http://157.175.131.51:8062/api/front/v1/',
    BASE_API_URL: 'http://192.168.0.228:8062/api/front/v1/',

   // BASE_BACKEND_API_URL: 'http://157.175.131.51:8062/api/',
    BASE_BACKEND_API_URL : 'http://192.168.0.228:8062/api/',
    
    COMPANY_URL: 'http://192.168.0.228/',
    // COMPANY_URL:'http://localhost/',

    BASE_URL:'http://192.168.0.228/',
...
export class Global {    
    ...
    doSearch(data:any) {
        ...
        let  url = this.elasticUrl+this.globalService.getWebsiteName()+'_product_'+this.globalService.getWebsiteId()+'/data/_search';
  ...
  getListingData( advancedSearch) {
		let url = GlobalVariable.elasticUrl+this.globalService.getWebsiteName()+'_product_'+this.globalService.getWebsiteId()+'/data/_search'
