...
@Component({
  selector: "app-creditburncondition.addedit",
  templateUrl: "templates/creditburncondition.addedit.component.html",
  providers: [Global, PromotionService],
  styleUrls:['templates/creditburn.component.css'],
})
export class CreditburnconditionAddeditComponent implements OnInit {
  public response: any;
  ...
  get_conditions(value: any, index: number) {
    let that = this;
    this.discount_fields.forEach(function(item: any,i) {
      if (item.field.value == value) {
        console.log(item);
        console.log(item.conditionValues);        
          ...
          data => {
            ...
            if (this.response.status == 1) {
              ...
              if (this.add_edit == "add") {
                ...
                this._router.navigate(["/credit_points_burn"]);
              } else {
                this._cookieService.remove("action");
  ...
  dialogCategoryRef: MatDialogRef<PointburnCategoryListComponent> | null;
  dialogProductRef: MatDialogRef<PointburnProductListComponent> | null;
  dialogCustomerGroupRef: MatDialogRef<PointburnCustomerGroupListComponent> | null;
  dialogCustomerRef: MatDialogRef<PointburnCustomerListComponent> | null;
  openPop(type: number, index: number) {
    ...
    if (type == 0) {
      ...
      this.dialogCategoryRef = this.dialog.open(PointburnCategoryListComponent, {
        data: data
      });
      ...
      this.dialogProductRef = this.dialog.open(PointburnProductListComponent, {
        data: data
      });
      ...
      this.dialogCustomerRef = this.dialog.open(PointburnCustomerListComponent, {
        data: data
      });
...
@Component({
  templateUrl: "../creditearn/templates/coupon_conditions_category.html",
  providers: [PromotionService]
})
export class PointburnCategoryListComponent implements OnInit {
  public formModel: any = {};
  public response: any;
  ...
  constructor(
    ...
    private _promotionService: PromotionService,
    public dialog: MatDialog,
    private dialogRef: MatDialogRef<PointburnCategoryListComponent>,
...
@Component({
  templateUrl: "../creditearn/templates/coupon_conditions_product.html",
  providers: [PromotionService]
})
export class PointburnProductListComponent implements OnInit {
  ...
  constructor(
    ...
    private _promotionService: PromotionService,
    public dialog: MatDialog,
    private dialogRef: MatDialogRef<PointburnProductListComponent>,
    private _cookieService: CookieService,
    @Inject(MAT_DIALOG_DATA) public data: any
  ) {}
...
@Component({
  templateUrl: "../creditearn/templates/coupon_conditions_customers.html",
  providers: [PromotionService]
})
export class PointburnCustomerListComponent implements OnInit {
  public customer_list: any = [];
  public response: any;
  public selectedAll: boolean;
  public bulk_ids: any = [];
  ...
  constructor(
    ...
    private _promotionService: PromotionService,
    public dialog: MatDialog,
    private dialogRef: MatDialogRef<PointburnCustomerListComponent>,
    private _cookieService: CookieService,
...
@Component({
  templateUrl: "../creditearn/templates/coupon_conditions_customerGroups.html",
  providers: [PromotionService]
})
export class PointburnCustomerGroupListComponent implements OnInit {
  ...
  constructor(
    ...
    private _promotionService: PromotionService,
    public dialog: MatDialog,
    private dialogRef: MatDialogRef<PointburnCustomerGroupListComponent>,
    private _cookieService: CookieService,
    @Inject(MAT_DIALOG_DATA) public data: any
  ) {}
