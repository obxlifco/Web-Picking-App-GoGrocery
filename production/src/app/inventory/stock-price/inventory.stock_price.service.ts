...
export class StockPriceService {
  ...
  warehouseLoad(websiteId,userId){
    ...
    in_Stock(data: any){
      return this._http.post(this.baseApiUrl+'update-product-stock/', data,this.globalService.getHttpOption()).pipe(
        map(res =>  res.json()),
        catchError(this.handleError),);
    }

    editPrice(data: any){
      return this._http.post(this.baseApiUrl+'update-product-price/', data,this.globalService.getHttpOption()).pipe(
        map(res =>  res.json()),
        catchError(this.handleError),);
    }
