...
public class Product {
    ...
    @Expose
    private List<VariantProductByCategoryId> variantProduct = null;
    ...
    public List<VariantProductByCategoryId> getVariantProduct() {
        return variantProduct;
    }

    public void setVariantProduct(List<VariantProductByCategoryId> variantProduct) {
