...
@SerializedName("shipping_setting_id")
@Expose
private Integer shippingSettingId;
...
public Integer getShippingSettingId() {
return shippingSettingId;
}

public void setShippingSettingId(Integer shippingSettingId) {
this.shippingSettingId = shippingSettingId;
}
