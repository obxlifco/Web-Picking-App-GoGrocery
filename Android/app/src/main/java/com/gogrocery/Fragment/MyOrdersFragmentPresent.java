...
public class MyOrdersFragmentPresent extends Fragment implements PaymentPageRedirectionInterface {

    public MyOrdersFragmentPresent() {
...
//        order_req_type = getArguments().getString("order_req_type");
    ...
    public void requestMyOrdersHistoryList() throws JSONException {
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
                Constants.BASE_URL + Constants.API_METHODS.ORDER_HISTORY + "?req_type=present", null,
    ...
    public void requestOrderCancel(String argOrderId, int argPosition) throws JSONException {
        mMyOrdersFragmentBinding.progressSpinKitView.setVisibility(View.VISIBLE);
        RequestQueue queue = Volley.newRequestQueue(getContext());
        System.out.println("Rahul : MyOrdersFragmentPresent : requestOrderCancel : token : " + mSharedPreferenceManager.getUserProfileDetail("token"));
        System.out.println("Rahul : MyOrdersFragmentPresent : requestOrderCancel : argOrderId : " + argOrderId);
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
                ...
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        System.out.println("Rahul : MyOrdersFragmentPresent : requestOrderCancel : response : " + response);
                        mMyOrdersFragmentBinding.progressSpinKitView.setVisibility(View.GONE);
                        Gson mGson = new Gson();
                        JSONObject mJsonObject = response;
                        try {
            ...
            public void onErrorResponse(VolleyError error) {
                mMyOrdersFragmentBinding.progressSpinKitView.setVisibility(View.GONE);
                mMyOrdersFragmentBinding.somethingwentwrong.setVisibility(View.VISIBLE);
                System.out.println("Rahul : MyOrdersFragmentPresent : requestOrderCancel : VolleyError : " + error.toString());
    ...
    public void onResume() {
        super.onResume();
        System.out.println("Rahul : MyOrdersFragmentPresent : onResume : ");
    }

    @Override
    public void onPause() {
        super.onPause();
        System.out.println("Rahul : MyOrdersFragmentPresent : onPause : ");
    }

    @Override
    public void onDetach() {
        super.onDetach();
        System.out.println("Rahul : MyOrdersFragmentPresent : onDetach : ");
    }

    @Override
    public void onStop() {
        super.onStop();
        System.out.println("Rahul : MyOrdersFragmentPresent : onStop : ");
    }

    @Override
    public void onDestroyView() {
        super.onDestroyView();
        System.out.println("Rahul : MyOrdersFragmentPresent : onDestroyView : ");
    }
}