...
public class ApiController {
    ...
    public void check3DSecureEnrollment(final String sessionId, final String amount, final String currency, final String threeDSecureId, final Check3DSecureEnrollmentCallback callback) {
        System.out.println("Rahul : ProcessPaymentActivity : check3DSecureEnrollment : sessionId : " + sessionId);
        System.out.println("Rahul : ProcessPaymentActivity : check3DSecureEnrollment : amount : " + amount);
        System.out.println("Rahul : ProcessPaymentActivity : check3DSecureEnrollment : currency : " + currency);
        System.out.println("Rahul : ProcessPaymentActivity : check3DSecureEnrollment : threeDSecureId : " + threeDSecureId);
    ...
    Pair<String, String> executeCreateSession() throws Exception {
        String jsonResponse = doJsonRequest(new URL(merchantServerUrl + "session"), "", "POST", "merchant.000008047730", "47598730227b8c3f2a850616e67332b6", HttpsURLConnection.HTTP_OK);
...
*/
    ...
    GatewayMap executeCheck3DSEnrollment(String sessionId, String amount, String currency, String threeDSecureId) throws Exception {
        System.out.println("Rahul : ApiController : executeCheck3DSEnrollment : sessionId : " + sessionId);
        System.out.println("Rahul : ApiController : executeCheck3DSEnrollment : amount : " + amount);
        System.out.println("Rahul : ApiController : executeCheck3DSEnrollment : currency : " + currency);
        System.out.println("Rahul : ApiController : executeCheck3DSEnrollment : threeDSecureId : " + threeDSecureId);

        GatewayMap request = new GatewayMap()
                .set("apiOperation", "CHECK_3DS_ENROLLMENT")
                .set("session.id", sessionId)
                .set("order.amount", amount)
                .set("order.currency", "AED")
                .set("3DSecure.authenticationRedirect.responseUrl", merchantServerUrl + "3DSecureId/" + threeDSecureId);

        System.out.println("Rahul : ApiController : executeCheck3DSEnrollment : responseUrl : " + merchantServerUrl + "3DSecureId/" + threeDSecureId);

        String jsonRequest = GSON.toJson(request);
        System.out.println("Rahul : ApiController : executeCheck3DSEnrollment : jsonRequest : " +jsonRequest);

        String jsonResponse = doJsonRequest(new URL(merchantServerUrl + "3DSecureId/" + threeDSecureId), jsonRequest, "PUT", "merchant.000008047730", "47598730227b8c3f2a850616e67332b6", HttpsURLConnection.HTTP_OK);
    ...
    String executeCompleteSession(String sessionId, String orderId, String transactionId, String amount, String currency, String threeDSecureId, Boolean isGooglePay) throws Exception {
        ...
        String jsonResponse = doJsonRequest(new URL(merchantServerUrl + "transaction/order/" + orderId + "transaction/" + transactionId), jsonRequest, "PUT", "merchant.000008047730", "47598730227b8c3f2a850616e67332b6", HttpsURLConnection.HTTP_OK);
    ...
    String doJsonRequest(URL address, String jsonRequest, String httpMethod, String username, String password, int... expectResponseCodes) {
        ...
        System.out.println("Rahul : ApiController : doJsonRequest : jsonRequest : " +jsonRequest);
        System.out.println("Rahul : ApiController : doJsonRequest : httpMethod : " +httpMethod);
        System.out.println("Rahul : ApiController : doJsonRequest : username : " +username);
        System.out.println("Rahul : ApiController : doJsonRequest : password : " +password);
        System.out.println("Rahul : ApiController : doJsonRequest : address : " +address);
        ...
        try {
            ...
            System.out.println("Rahul : ApiController : doJsonRequest : connection : " +connection.getURL().toString());
        ...
        try {
            ...
            System.out.println("Rahul : ApiController : doJsonRequest : responseCode : " +responseCode);
        ...
        try {
            ...
            System.out.println("Rahul : ApiController : doJsonRequest : responseBody : " +responseBody);
