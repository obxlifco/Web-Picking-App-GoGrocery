...
import com.gogrocery.databinding.ActivityAboutUsBinding;
...
ActivityAboutUsBinding activityAboutUsBinding;
    ...
    private void setUpClick() {
        activityAboutUsBinding.ivBack.setOnClickListener(this);
        activityAboutUsBinding.ivBack.setOnClickListener(v->{
            super.onBackPressed();
        });
    ...
    public void requestCmsMenu(String urlRequest) throws JSONException {
        activityAboutUsBinding.loading.setVisibility(View.VISIBLE);
        ...
        JsonObjectRequest mJsonObjectRequest = new JsonObjectRequest(Request.Method.POST,
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        activityAboutUsBinding.loading.setVisibility(View.GONE);
                                ...
                                if (menuCmsModel.getStatus().equals(1)) {
                                    ...
                                    try {
                                        ...
                                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                                            activityAboutUsBinding.tvText.setText(Html.fromHtml(innerCMSModel.getInsertables().get(0).getProperties().get(0).getValue(), Html.FROM_HTML_MODE_COMPACT));

                                        } else {
                                            activityAboutUsBinding.tvText.setText(Html.fromHtml(innerCMSModel.getInsertables().get(0).getProperties().get(0).getValue()));
                                        }

                                        //  activityAboutUsBinding.tvText.setText(innerCMSModel.getInsertables().get(0).getProperties().get(0).getValue());
