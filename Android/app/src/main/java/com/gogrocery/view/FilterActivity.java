...
public class FilterActivity extends AppCompatActivity implements FilterMenuConnectInterface, FilterRightMenuInterface {
    ...
    private FilterRightSideMenuOldAdapter mRightSideMenuAdapter;
...
try {
    ...
    private void setRightSideMenuFilterCategory() {
        mRightSideMenuAdapter = new FilterRightSideMenuOldAdapter(getApplicationContext(), mChidList, this, this);
        LinearLayoutManager mLayoutManager = new LinearLayoutManager(getApplicationContext(), LinearLayoutManager.VERTICAL, false);
