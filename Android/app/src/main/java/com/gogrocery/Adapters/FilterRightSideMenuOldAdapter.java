...
public class FilterRightSideMenuOldAdapter extends RecyclerView.Adapter<FilterRightSideMenuOldAdapter.MyViewHolder> {


    private Context mContext;
    private List<Child> mFilterModelList;
    private FilterRightMenuInterface mFilterRightMenuInterface;
    private FilterActivity argFilterType;
    private LinearLayout.LayoutParams params;

    public FilterRightSideMenuOldAdapter(Context mContext,
                                         List<Child> mFilterModelList, FilterRightMenuInterface mFilterRightMenuInterface, FilterActivity argFilterType) {
