...
public class ProductSubstituteAdapter extends RecyclerView.Adapter<ProductSubstituteAdapter.MyViewHolder> {

    private int isVisible=-1;
    private Context mContext;
    private List<com.gogrocery.Models.MyOrdersHistoryModel.Data> mMyOrdersHistoryList;
    private gotoSubstituteList mPaymentPageRedirectionInterface;


    public ProductSubstituteAdapter(Context mContext,
                                    List<com.gogrocery.Models.MyOrdersHistoryModel.Data> mMyOrdersHistoryList, gotoSubstituteList mPaymentPageRedirectionInterface) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
     ...
     /*   holder.tvCancel.setOnClickListener(new View.OnClickListener() {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mPaymentPageRedirectionInterface.onSelectedItem(mDataInner.getId());
            }
        });
    }
