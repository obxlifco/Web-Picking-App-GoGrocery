...
public class StoreTypeAdapter extends RecyclerView.Adapter<StoreTypeAdapter.MyViewHolder> {


    private Context mContext;
    private StoreTypeItemClickListner storeTypeItemClickListner;
    List<StoreCategoryModel> data;

    public StoreTypeAdapter(Context mContext,
                            List<StoreCategoryModel> data, StoreTypeItemClickListner storeTypeItemClickListner) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.store_type_row, parent, false);
