...
public class StockItem {
	...
	private ChannelCurrencyProductPrice channelCurrencyProductPrice;
	...
	public void setChannelCurrencyProductPrice(ChannelCurrencyProductPrice channelCurrencyProductPrice){
		this.channelCurrencyProductPrice = channelCurrencyProductPrice;
	}

	public ChannelCurrencyProductPrice getChannelCurrencyProductPrice(){
		return channelCurrencyProductPrice;
	}

	public void setEbay(int ebay){
		this.ebay = ebay;
	}
	...
	@Override
 	public String toString(){
		return 
			...
			",taxclass = '" + taxclass + '\'' + 
			",mp_description = '" + mpDescription + '\'' + 
			",is_auctionable = '" + isAuctionable + '\'' + 
			",amazon_itemid = '" + amazonItemid + '\'' + 
			",avg_cost = '" + avgCost + '\'' + 
			",default_price = '" + defaultPrice + '\'' + 
			",veg_nonveg_type = '" + vegNonvegType + '\'' + 
			",product_offer_desc = '" + productOfferDesc + '\'' + 
			",mp_templates = '" + mpTemplates + '\'' + 
			",isdeleted = '" + isdeleted + '\'' + 
			",is_facebook_product = '" + isFacebookProduct + '\'' + 
			",features = '" + features + '\'' + 
			",uom = '" + uom + '\'' + 
			",org_pro_con = '" + orgProCon + '\'' + 
			",product_offer_start_date = '" + productOfferStartDate + '\'' + 
			",po_taxclass = '" + poTaxclass + '\'' + 
			",hsn_id = '" + hsnId + '\'' + 
			",min_price_rule = '" + minPriceRule + '\'' + 
			",modified = '" + modified + '\'' + 
			",id = '" + id + '\'' + 
			",uom_name = '" + uomName + '\'' + 
			",ebay_item_id = '" + ebayItemId + '\'' + 
			",sku = '" + sku + '\'' + 
			",price_formula_id_for_supplier = '" + priceFormulaIdForSupplier + '\'' + 
			",ebay_listing_endtime = '" + ebayListingEndtime + '\'' + 
			",brand = '" + brand + '\'' + 
			",meta_url = '" + metaUrl + '\'' + 
			",slug = '" + slug + '\'' + 
			",meta_title = '" + metaTitle + '\'' + 
			",created = '" + created + '\'' + 
			",shippingclass_id = '" + shippingclassId + '\'' + 
			",weight = '" + weight + '\'' + 
			",sla = '" + sla + '\'' + 
			",warehouse = '" + warehouse + '\'' + 
			",last_cost = '" + lastCost + '\'' + 
			",numberof_view = '" + numberofView + '\'' + 
			",amazon = '" + amazon + '\'' + 
			",meta_description = '" + metaDescription + '\'' + 
			",webshop = '" + webshop + '\'' + 
			",customer_group = '" + customerGroup + '\'' + 
			",name = '" + name + '\'' + 
			",channel_currency_product_price = '" + channelCurrencyProductPrice + '\'' + 
			",ebay = '" + ebay + '\'' + 
			",ebay_listing_time = '" + ebayListingTime + '\'' + 
			",order_id = '" + orderId + '\'' + 
			...
			",mp_features = '" + mpFeatures + '\'' + 
			",video = '" + video + '\'' + 
			",title = '" + title + '\'' + 
			",related_product_skus = '" + relatedProductSkus + '\'' + 
			",meta_og_tags = '" + metaOgTags + '\'' + 
			",product_images = '" + productImages + '\'' + 
			",is_import = '" + isImport + '\'' + 
			",ean = '" + ean + '\'' + 
			",category_id = '" + categoryId + '\'' + 
			",numberof_sale = '" + numberofSale + '\'' + 
			",visible_in_listing = '" + visibleInListing + '\'' + 
			",product_stock = '" + productStock + '\'' + 
			",ebay_addstatus = '" + ebayAddstatus + '\'' + 
			",pdf_file_path = '" + pdfFilePath + '\'' + 
			",ebay_listing_starttime = '" + ebayListingStarttime + '\'' + 
			",max_order_unit = '" + maxOrderUnit + '\'' + 
			",ebay_listing_version = '" + ebayListingVersion + '\'' + 
			",supc = '" + supc + '\'' + 
			",quantity = '" + quantity + '\'' + 
			",mp_system_requirements = '" + mpSystemRequirements + '\'' + 
			",order_price = '" + orderPrice + '\'' + 
			",ip_address = '" + ipAddress + '\'' + 
			",max_price_rule = '" + maxPriceRule + '\'' + 
			",npn = '" + npn + '\'' + 
			",product_offer_end_date = '" + productOfferEndDate + '\'' + 
			",url = '" + url + '\'' + 
			",isblocked = '" + isblocked + '\'' + 
			",twitter_addstatus = '" + twitterAddstatus + '\'' + 
			",cost_per_unit = '" + costPerUnit + '\'' + 
			",ebay_listing_build = '" + ebayListingBuild + '\'' + 
			",price_formula_id_for_customer = '" + priceFormulaIdForCustomer + '\'' + 
			",asin = '" + asin + '\'' + 
			",visibility_id = '" + visibilityId + '\'' + 
			",new_date = '" + newDate + '\'' + 
			",total_listingfee = '" + totalListingfee + '\'' + 
