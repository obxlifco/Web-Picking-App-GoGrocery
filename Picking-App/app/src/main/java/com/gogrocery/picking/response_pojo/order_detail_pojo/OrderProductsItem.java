...
public class OrderProductsItem{
	...
	private double shippingCgstPercentage;
	...
	private double shippingIgstPercentage;
	...
	private double shippingSgstPercentage;
	...
	private Double productDiscountPriceBase;
	...
	private int minimum_substitute_limit;

	@SerializedName("maximum_substitute_limit")
	private int maximum_substitute_limit;

	@SerializedName("product_categories")
	private List<String> product_all_category;
	...
	public void setShippingCgstPercentage(double shippingCgstPercentage){
		this.shippingCgstPercentage = shippingCgstPercentage;
	}

	public double getShippingCgstPercentage(){
	...
	public void setShippingIgstPercentage(double shippingIgstPercentage){
		this.shippingIgstPercentage = shippingIgstPercentage;
	}

	public double getShippingIgstPercentage(){
	...
	public void setShippingSgst(int shippingSgst){
		this.shippingSgst = shippingSgst;
	}

	public int getShippingSgst(){
		return shippingSgst;
	}
	...
	public void setShippingSgstPercentage(double shippingSgstPercentage){
		this.shippingSgstPercentage = shippingSgstPercentage;
	}

	public double getShippingSgstPercentage(){
	...
	public void setProductDiscountPriceBase(Double productDiscountPriceBase){
		this.productDiscountPriceBase = productDiscountPriceBase;
	}

	public Double getProductDiscountPriceBase(){
	...
	public int getMinimum_substitute_limit() {
		return minimum_substitute_limit;
	}

	public void setMinimum_substitute_limit(int minimum_substitute_limit) {
		this.minimum_substitute_limit = minimum_substitute_limit;
	}

	public int getMaximum_substitute_limit() {
		return maximum_substitute_limit;
	}

	public void setMaximum_substitute_limit(int maximum_substitute_limit) {
		this.maximum_substitute_limit = maximum_substitute_limit;
	}

	public List<String> getProduct_all_category() {
		return product_all_category;
	}

	public void setProduct_all_category(List<String> product_all_category) {
		this.product_all_category = product_all_category;
	}
	...
	@Override
 	public String toString(){
		return 
			"OrderProductsItem{" + 
			"sgst = '" + sgst + '\'' + 
			",giftwrap_price_base = '" + giftwrapPriceBase + '\'' + 
			",cgst_percentage = '" + cgstPercentage + '\'' + 
			",product_price = '" + productPrice + '\'' + 
			",product_discount_price = '" + productDiscountPrice + '\'' + 
			",shortage = '" + shortage + '\'' + 
			",hsn_id = '" + hsnId + '\'' + 
			",shipping_cgst_percentage = '" + shippingCgstPercentage + '\'' + 
			",id = '" + id + '\'' + 
			",shipping_price_base = '" + shippingPriceBase + '\'' + 
			",order = '" + order + '\'' + 
			",shipping_price = '" + shippingPrice + '\'' + 
			",shipping_tax_base = '" + shippingTaxBase + '\'' + 
			",created = '" + created + '\'' + 
			",excise_duty_per = '" + exciseDutyPer + '\'' + 
			",weight = '" + weight + '\'' + 
			",assign_wh = '" + assignWh + '\'' + 
			",shipping_igst = '" + shippingIgst + '\'' + 
			",tags = '" + tags + '\'' + 
			",shipping_igst_percentage = '" + shippingIgstPercentage + '\'' + 
			",product_disc_type = '" + productDiscType + '\'' + 
			",trents_picklist_id = '" + trentsPicklistId + '\'' + 
			",giftwrap_tax_base = '" + giftwrapTaxBase + '\'' + 
			",pick_as_substitute = '" + pickAsSubstitute + '\'' + 
			",returns = '" + returns + '\'' + 
			",status = '" + status + '\'' + 
			",giftwrap_price = '" + giftwrapPrice + '\'' + 
			",product_price_base = '" + productPriceBase + '\'' + 
			...
			",shipping_discount_base = '" + shippingDiscountBase + '\'' + 
			",igst = '" + igst + '\'' + 
			",shipping_sgst_percentage = '" + shippingSgstPercentage + '\'' + 
			...
			",tax_name = '" + taxName + '\'' + 
			",product_discount_price_base = '" + productDiscountPriceBase + '\'' + 
			",mrp = '" + mrp + '\'' + 
			",cgst = '" + cgst + '\'' + 
			",cess = '" + cess + '\'' + 
			...
			",giftwrap_tax = '" + giftwrapTax + '\'' + 
			",warehouse_id = '" + warehouseId + '\'' + 
			",product_excise_duty = '" + productExciseDuty + '\'' + 
			",minimum_substitute_limit = '" + minimum_substitute_limit + '\'' +
			",maximum_substitute_limit = '" + maximum_substitute_limit + '\'' +
			",product_all_category = '" + product_all_category + '\'' +
