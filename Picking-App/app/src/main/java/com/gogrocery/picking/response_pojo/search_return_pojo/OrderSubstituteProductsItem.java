...
import com.gogrocery.picking.response_pojo.order_detail_pojo.Product;

import javax.annotation.Generated;

@Generated("com.robohorse.robopojogenerator")
public class OrderSubstituteProductsItem {
	...
	private String send_approval;

	@SerializedName("warehouse_id")
	private int warehouseId;

	@SerializedName("product_excise_duty")
	private int productExciseDuty;
	...
	public void setProductExciseDuty(int productExciseDuty){
		this.productExciseDuty = productExciseDuty;
	}

	public int getProductExciseDuty(){
		return productExciseDuty;
	}

	public String getSend_approval() {
		return send_approval;
	}

	public void setSend_approval(String send_approval) {
