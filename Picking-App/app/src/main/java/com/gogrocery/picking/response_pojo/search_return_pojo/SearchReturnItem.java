...
public class SearchReturnItem {
	...
	@SerializedName("order_substitute_products")
	private List<OrderSubstituteProductsItem> orderSubstituteProducts;
	...
	private String deliverySapEcustomerStateNo;
	...
	private double grossDiscountAmountBase;
	...
	public void setOrderSubstituteProducts(List<OrderSubstituteProductsItem> orderSubstituteProducts){
		this.orderSubstituteProducts = orderSubstituteProducts;
	}

	public List<OrderSubstituteProductsItem> getOrderSubstituteProducts(){
		return orderSubstituteProducts;
	}
	...
	public void setTrentPicklistId(int trentPicklistId){
	...
	public void setOrderActivity(List<OrderActivityItem> orderActivity){
	...
	public void setDeliverySapEcustomerStateNo(String deliverySapEcustomerStateNo){
		this.deliverySapEcustomerStateNo = deliverySapEcustomerStateNo;
	}

	public String getDeliverySapEcustomerStateNo(){
	...
	public void setGrossAmountBase(double grossAmountBase){
	...
	public void setGrossDiscountAmountBase(double grossDiscountAmountBase){
		this.grossDiscountAmountBase = grossDiscountAmountBase;
	}

	public double getGrossDiscountAmountBase(){
	...
	public void setCustomerAddressbook(CustomerAddressbook customerAddressbook){
		this.customerAddressbook = customerAddressbook;
	}
	...
	public void setWebshop(int webshop){
	...
	@Override
 	public String toString(){
		return 
			"SearchReturnItem{" +
			"tracking_mail_send = '" + trackingMailSend + '\'' + 
			",delivery_company = '" + deliveryCompany + '\'' + 
			",channel_order_id = '" + channelOrderId + '\'' + 
			",custom_msg = '" + customMsg + '\'' + 
			",tally_sales_entered = '" + tallySalesEntered + '\'' + 
			",isdeleted = '" + isdeleted + '\'' + 
			...
			",order_substitute_products = '" + orderSubstituteProducts + '\'' + 
			",shipment_id = '" + shipmentId + '\'' + 
			",sort_by_distance = '" + sortByDistance + '\'' + 
			",grn_created_date = '" + grnCreatedDate + '\'' + 
			",shipping_cost_base = '" + shippingCostBase + '\'' + 
			",tags = '" + tags + '\'' + 
			",billing_postcode = '" + billingPostcode + '\'' + 
			",paid_amount = '" + paidAmount + '\'' + 
			",flag_order = '" + flagOrder + '\'' + 
			",trent_picklist_id = '" + trentPicklistId + '\'' + 
			",delivery_name = '" + deliveryName + '\'' + 
			",send_notes = '" + sendNotes + '\'' + 
			",assign_to = '" + assignTo + '\'' + 
			",pay_txntranid = '" + payTxntranid + '\'' + 
			...
			",delivery_street_address1 = '" + deliveryStreetAddress1 + '\'' + 
			",order_activity = '" + orderActivity + '\'' + 
			",billing_country = '" + billingCountry + '\'' + 
			",net_amount_base = '" + netAmountBase + '\'' + 
			",refferal_code = '" + refferalCode + '\'' + 
			",payment_method_name = '" + paymentMethodName + '\'' + 
			",delivery_sap_ecustomer_state_no = '" + deliverySapEcustomerStateNo + '\'' + 
			",assigned_show_room = '" + assignedShowRoom + '\'' + 
			",isblocked = '" + isblocked + '\'' + 
			",shipping_cost_excl_tax = '" + shippingCostExclTax + '\'' + 
			",gross_amount_base = '" + grossAmountBase + '\'' + 
			",channel_shipping_status = '" + channelShippingStatus + '\'' + 
			",delivery_postcode = '" + deliveryPostcode + '\'' + 
			",delivery_state_name = '" + deliveryStateName + '\'' + 
			...
			",area_id = '" + areaId + '\'' + 
			",gross_discount_amount_base = '" + grossDiscountAmountBase + '\'' + 
			",createdby = '" + createdby + '\'' + 
			...
			",pay_txndate = '" + payTxndate + '\'' + 
			",time_slot_id = '" + timeSlotId + '\'' + 
			",created = '" + created + '\'' + 
			",customer_addressbook = '" + customerAddressbook + '\'' + 
			",assign_wh = '" + assignWh + '\'' + 
			...
			",webshop = '" + webshop + '\'' + 
			",paid_amount_base = '" + paidAmountBase + '\'' + 
			...
			",billing_street_address1 = '" + billingStreetAddress1 + '\'' + 
			",return_note = '" + returnNote + '\'' + 
			",received_amount = '" + receivedAmount + '\'' + 
			",expected_delivery_date = '" + expectedDeliveryDate + '\'' + 
			",zone_id = '" + zoneId + '\'' + 
			",buy_status = '" + buyStatus + '\'' + 
			",channel_orderlineitem_id = '" + channelOrderlineitemId + '\'' + 
